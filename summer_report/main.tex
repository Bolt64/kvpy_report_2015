...
\begin{defn}
A subgroup $H$ of a group is called normal iff for all $a \in G$, $Ha = aH$. 
\end{defn}
...
The transformations mentioned in lemma \autoref{elementary} are called elementary Nielsen transformations, and the transformation mentioned in lemma \autoref{conj} is called the conjugation transformation.
...
\begin{lem}
The fundamental group of an $n$-space is the free group of rank $n$.
\end{lem}
